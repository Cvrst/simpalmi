...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Guest Hub Hello everyone<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=White>Fluxus is down!!<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Cyan>So use AcerusX for better information!nformation!<Color=/>"):Display()
    wait(.29)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Guest Hub", HidePremium = false, IntroText = "GuestHubOrion", SaveConfig = true, ConfigFolder = "GuestHub"})
...
W:AddLabel("Protected By")
W:AddLabel("Guest Hub Script")
W:AddLabel("Discord idk")
local Section = W:AddSection({
    Name = "Status"
})
...
local locallv = W:AddLabel("Level")
    ...
    local LevelFarmFarm W:AddLabel("Kaitun : IDK(Comming Soon)")
...
local AttackList = {"0.01", "0.1", "0.175", "0.2", "0.25", "0.3", "0.35", "0.4", "0.45", "0.5", "0.55", "0.6", "0.65", "0.7", "0.75", "0.8", "0.85", "0.9", "0.95", "0.1"}
M:AddDropdown({
...
spawn(function()
    while wait(.1) do
        if _G.FastAttackDelay then
            pcall(function()
                if _G.FastAttackDelay == "0.01" then
...
IQ:AddToggle({
    ...
    Callback = function(Value)
        ...
        IQ:AddLabel("For anyone who understands, this is an automatic dummy")
